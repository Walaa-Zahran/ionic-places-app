  ...
  fetchPlaces() {
    return this.http
      .get<{ [key: string]: PlaceData }>(
        'https://ionic-angular-course-eb216-default-rtdb.firebaseio.com/offered-places.json'
      )
      .pipe(
        map(resData => {
          const places = [];
    ...
    return this.places.pipe(
      ...
      switchMap(places => {
        ...
        return this.http.put(
          `https://ionic-angular-course-eb216-default-rtdb.firebaseio.com/offered-places/${placeId}.json`,
