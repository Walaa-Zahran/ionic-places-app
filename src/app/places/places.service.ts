...
export class PlacesService {
  ...
  addPlace(title: string, description: string, price: number, dateFrom: Date, dateTo: Date) {
    ...
    return this.http.post<{ name: string }>('https://ionic-angular-course-eb216-default-rtdb.firebaseio.com/offered-plaes.json', { ...newPlace, id: null }).pipe(switchMap(resData => {
