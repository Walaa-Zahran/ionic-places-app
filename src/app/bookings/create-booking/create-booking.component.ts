...
export class CreateBookingComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.selectedMode === 'random' && this.startDate !== undefined || '' && this.endDate !== undefined || '') {
      this.startDate = new Date(availableFrom.getTime() * (availableTo.getTime() - 7 * 24 * 60 * 60 * 1000 - availableFrom.getTime())).toISOString();
